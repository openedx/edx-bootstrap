...
<main className="col-12 col-md-9 col-xl-8 py-md-3 pl-md-5 bd-content" role="main">
  ...
  <div id="carbonads"><span><span className="carbon-wrap"><a href="//srv.carbonads.net/ads/click/x/GTND42QWCA7D623MFT74YKQMCESICK3JC6BDTZ3JCWBD5K7ICY7ITKQKC6BIV27LCV7DVK3EHJNCLSIZ?segment=placement:getbootstrapcom;" className="carbon-img" target="_blank" rel="noopener"><img src="https://cdn4.buysellads.net/uu/1/42500/1546365873-1538007875-Monday-laptop_purple_graph.png" alt border={0} height={100} width={130} style={{maxWidth: 130}} /></a><a href="//srv.carbonads.net/ads/click/x/GTND42QWCA7D623MFT74YKQMCESICK3JC6BDTZ3JCWBD5K7ICY7ITKQKC6BIV27LCV7DVK3EHJNCLSIZ?segment=placement:getbootstrapcom;" className="carbon-text" target="_blank" rel="noopener">Project tracking, teamwork &amp; client reporting like you've never seen before.</a></span><a href="http://carbonads.net/?utm_source=getbootstrapcom&utm_medium=ad_via_link&utm_campaign=in_unit&utm_term=carbon" className="carbon-poweredby" target="_blank" rel="noopener">ads via Carbon</a><img src="https://ad.doubleclick.net/ddm/trackimp/N728909.734586CARBONADS.NET/B20652854.212994676;dc_trk_aid=414618443;dc_trk_cid=104372716;ord=154722572;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=?" border={0} height={1} width={1} style={{display: 'none'}} /></span></div>
  <h2 id="examples"><span className="bd-content-title">Examples<a className="anchorjs-link " href="#examples" aria-label="Anchor" data-anchorjs-icon="#" style={{paddingLeft: '0.375em'}} /></span></h2>
  ...
  <h3 id="link-color"><span className="bd-content-title">Link color<a className="anchorjs-link " href="#link-color" aria-label="Anchor" data-anchorjs-icon="#" style={{paddingLeft: '0.375em'}} /></span></h3>
  ...
  <h3 id="additional-content"><span className="bd-content-title">Additional content<a className="anchorjs-link " href="#additional-content" aria-label="Anchor" data-anchorjs-icon="#" style={{paddingLeft: '0.375em'}} /></span></h3>
  ...
  <h3 id="dismissing"><span className="bd-content-title">Dismissing<a className="anchorjs-link " href="#dismissing" aria-label="Anchor" data-anchorjs-icon="#" style={{paddingLeft: '0.375em'}} /></span></h3>
  ...
  <h2 id="javascript-behavior"><span className="bd-content-title">JavaScript behavior<a className="anchorjs-link " href="#javascript-behavior" aria-label="Anchor" data-anchorjs-icon="#" style={{paddingLeft: '0.375em'}} /></span></h2>
  <h3 id="triggers"><span className="bd-content-title">Triggers<a className="anchorjs-link " href="#triggers" aria-label="Anchor" data-anchorjs-icon="#" style={{paddingLeft: '0.375em'}} /></span></h3>
  ...
  <h3 id="methods"><span className="bd-content-title">Methods<a className="anchorjs-link " href="#methods" aria-label="Anchor" data-anchorjs-icon="#" style={{paddingLeft: '0.375em'}} /></span></h3>
  <table>
    <thead>
      <tr>
        <th>Method</th>
  ...
  <h3 id="events"><span className="bd-content-title">Events<a className="anchorjs-link " href="#events" aria-label="Anchor" data-anchorjs-icon="#" style={{paddingLeft: '0.375em'}} /></span></h3>
